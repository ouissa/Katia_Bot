...
/* try{
  const carbonEmissionData = await axios.get('https://sheets.googleapis.com/v4/spreadsheets/1IBk3ELGNOo02dtKHWv28akYnR-59F3-o/values/Sheet1!A1:D5')
}catch(error) {
  console.log('API feh mochkil')
  throw error
}*/
  
// Geting the prediction data
